...
const submitPayment = async () => {
    ...
    try {
        ...
        if (!userEmail) throw new Error('User email is required for admin payment');
        ...
        <Card>
            <template #content>
                ...
                <div v-else class="p-fluid">
                    ...
                    <div class="field mb-4">
                        <label for="email" class="font-bold block mb-2">User Email</label>
                        <InputText id="email" v-model="email" placeholder="Enter user email" class="w-full" :disabled="isLoading || !selectedTicketForPayment" />
                    </div>
